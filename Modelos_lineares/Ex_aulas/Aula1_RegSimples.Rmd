...
Intervalo de confiança: estima quanto, em média, é a perda sanguínea de um grupo de pacientes com determinado número de vermes
...
A cada aumento de 1 verme, ocorre um aumento de 0.04 (95%IC 0.026 - 0.056) na perda de sangue, sendo que 71,6% (Multiple R-squared) da variabilidade da perda de sangue em relação à perda média da amostra é explicada pelo aumento do número de vermes.


Estimando intervalo de predição para cada observação do banco

Intervalo de predição: prediz a perda de sangue para um paciente que apresenta determinado número de vermes
