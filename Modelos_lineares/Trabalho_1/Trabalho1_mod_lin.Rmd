...
Acreditamos que investimento em pesquisa do NIH pode ser explicado pela morbidade e mortalidade relacionada à doença. Dessa forma, com exceção de incidência em 1990 (que está contida em prevalência de 1990), todas as variáveis preditoras poderiam ajudar a explicar o desfecho, pois se relacionam a morbidade ou mortalidade.


```{r mr_dol_1}

mr_dol_1 <- lm(data = dados, formula = (dollars ~ preval + hospdays + mort + yrslost + disabil))
