...
Como sabemos que disabil inclui yrslost (havendo risco de multicolinearidade), outra opção seria comparar yrslost com seu complementar, YLD (disabil - yrslost)
...
De modo geral, os resíduos estão concentrados em torno do zero. No entanto, há duas observações, 1 (AIDS) e 5 (doença cardíaca isquêmica), com resíduos altos. Ou seja, o investimento dado a essas doenças não corresponde ao investimento esperado pelo modelo, conforme o conjunto de preditores dessas doenças (prevalência, anos de vida perdidos por morte prematura e anos de vida ajustados para incapacidade).
Além disso, essas observações apresentam altas distâncias de Cook, sendo valores influentes para o modelo de regressão.
