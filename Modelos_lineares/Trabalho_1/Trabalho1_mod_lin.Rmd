...
```{r correlation_plot}
### Painel de 100 cores e matriz de correlacao ordenada
...
As variáveis dos grupos "morte" e "morbidade" de menor correlação são yrslost e disabil. Como sabemos que disabil inclui yrslost, poderíamos comparar yrslost com seu complementar, YLD.
